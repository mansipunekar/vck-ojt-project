...
const Apply = () => {
  return (
    ...
    <p class="note">
        For detailed information on postgraduate program admissions, specific program syllabi, and fee structures, please visit our <a href="#">Courses page</a> or <a href="#">Contact us</a> directly.
    </p>
      </div>
    </header>
    </>
